...
class MyClass extends SliderTheme{
  MyClass({required super.data, required super.child});
...
/// [CustomSliderTheme.of]. When a widget uses [CustomSliderTheme.of], it is automatically
...
class CustomSliderTheme extends InheritedTheme {
  ...
  /// Returns the data from the closest [CustomSliderTheme] instance that encloses
  /// the given context.
  ///
  /// Defaults to the ambient [ThemeData.sliderTheme] if there is no
  /// [CustomSliderTheme] in the given build context.
  ///
  /// {@tool snippet}
  ///
  /// ```dart
  ...
  static SliderThemeData of(BuildContext context) {
    final CustomSliderTheme? inheritedTheme = context.dependOnInheritedWidgetOfExactType<CustomSliderTheme>();
    return inheritedTheme != null ? inheritedTheme.data : Theme.of(context).sliderTheme;
  }

  @override
  Widget wrap(BuildContext context, Widget child) {
    return CustomSliderTheme(data: data, child: child);
  }

  @override
  bool updateShouldNotify(CustomSliderTheme oldWidget) => data != oldWidget.data;
}
...
/// theme.
///
/// Use this class to configure a [CustomSliderTheme] widget, or to set the
/// [ThemeData.sliderTheme] for a [Theme] widget.
///
/// To obtain the current ambient slider theme, use [CustomSliderTheme.of].
///
...
/// See also:
///
///  * [CustomSliderTheme] widget, which can override the slider theme of its
///    children.
///  * [Theme] widget, which performs a similar function to [CustomSliderTheme],
...
class SliderThemeData with Diagnosticable {
  ...
  /// [copyWith] on the one you get from [CustomSliderTheme.of], or create an
...
///  * [CustomSliderTheme], which can be used to configure the tick mark shape of all
...
///  * [CustomSliderTheme], which can be used to configure the thumb shape of all
///    sliders in a widget subtree.
...
///  * [CustomSliderTheme], which can be used to configure the thumb shapes of all
...
///  * [CustomSliderTheme], which can be used to configure the overlay shape of all
///    sliders in a widget subtree.
...
///  * [CustomSliderTheme], which can be used to configure the slider value indicator
...
///  * [CustomSliderTheme], which can be used to configure the range slider value
